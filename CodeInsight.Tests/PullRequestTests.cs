...
namespace CodeInsight.Tests
{
    public class PullRequestTests
    {
        ...
        public void RepositoryDayStatistics()
        {
            ...
            var pr1 = new PullRequest(NonEmptyString.Create("1").Get(), aId, 10, 20, createdAt, Some(createdAt.Plus(Duration.FromDays(5))), None<Instant>(), 0);
            var pr2 = new PullRequest(NonEmptyString.Create("2").Get(), bId, 20, 40, createdAt, Some(createdAt.Plus(Duration.FromDays(9))), None<Instant>(), 0);
            var pr3 = new PullRequest(NonEmptyString.Create("3").Get(), aId, 100, 60, createdAt, None<Instant>(), None<Instant>(), 0);
